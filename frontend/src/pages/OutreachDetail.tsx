    ...
    <div className="border border-[var(--color-rule)] rounded-[var(--radius-md)] bg-[var(--color-paper-2)]">
      ...
      <div className="px-4 py-3 space-y-2">
        <input
          ...
          aria-label="Předmět"
          placeholder="Předmět"
          className="w-full text-sm font-medium border border-transparent hover:border-[var(--color-rule)] focus-visible:border-[var(--color-rule)] rounded-[var(--radius-sm)] bg-transparent px-2 py-1 text-[var(--color-ink)] focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] disabled:opacity-70"
        />
        <textarea
          value={body}
          disabled={locked}
          ...
          className="w-full text-sm leading-relaxed border border-[var(--color-rule)] rounded-[var(--radius-sm)] bg-[var(--color-paper-3)] px-3 py-2 text-[var(--color-ink)] focus-visible:ring-2 focus-visible:ring-[var(--color-focus)] disabled:opacity-70 font-[family-name:var(--font-mono)]"
        />
      </div>
