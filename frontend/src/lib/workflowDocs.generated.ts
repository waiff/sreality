...
export const WORKFLOW_DOCS: WorkflowDoc[] = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "name": "dry_run",
        "description": "Report what each column still needs and exit",
        "required": false,
        "type": "choice",
        "default": "false",
        "options": [
    ...
    "concurrencyGroup": "apply-r2-constraints",
    "cancelInProgress": false,
    "timeoutMinutes": 180,
    "permissions": "contents: read",
    "runsUrl": "https://github.com/waiff/sreality/actions/workflows/apply_r2_constraints.yml",
