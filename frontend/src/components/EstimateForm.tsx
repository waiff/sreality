...
import { ControlGroup, Section, TriRow, PickButton } from '@/components/controls';
...
export default function EstimateForm({
  ...
  return (
    ...
    >
      ...
      <ControlGroup title="Location & size">
        <div>
          <Row>
      ...
      <ControlGroup title="Building & amenities">
      ...
      <ControlGroup title="Yield">
        {state.estimate_kind === 'rent' ? (
          <Section label="Purchase price">
            <NumberInput
              id="f-price"
          ...
          <Section label="Expected monthly rent">
            <NumberInput
              id="f-erent"
...
/* -------------------------------------------------------------------------- */
/* Form-local layout helpers (Row, Field, FieldHeader)                        */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* Disposition single-select (button grid)                                    */
/* -------------------------------------------------------------------------- */
