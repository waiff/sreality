...
- [ ] **DINOv3 readiness build (2026-09-05, PROGRAM.md ledger (f)):** vector table
      (migration 480, draft PR), bake-off harness rewrite, production embedding job, and the
      per-tag heads trainer — four independent PRs, built and tested but not run against real
      data (training set still unfinalized). See PROGRAM.md for the full breakdown.
