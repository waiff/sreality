...
13:29Z (≈130 per worker slot), **0 by 07:43Z on 09-09** — the throttled `*/15` Actions drain took the
bulk once its cron fired. Then, on the merged review-fixed lane (#1351, `a3a91683`):
...
in the same reconcile (their payloads had been refetched meanwhile), so they are in the 6,519.
