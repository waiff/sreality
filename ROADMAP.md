...
| Location data | 🟡 active (W1/W1v/W2/W3 shipped, W2a closing, **W4 gate PASS on sreality 2026-09-09** — legacy share 8.4 % → 0.03 %; closes on one operator dispatch of 136 bezrealitky rows; next: W6 preconditions) | Greenfield location SSOT (claims → resolutions → projections on RÚIAN, four-axis precision, licence enforcement); spine live in **shadow** (migs 380–389, 399–400, 402–408), nothing reads it until W6; **W3 history backfill SHIPPED 2026-08-19 — 1.63 M snapshots mined, 92,312 historical claims, ~10.85 M observations, all four gate arms pass; measured oscillation is small (804 of 327,113 listings ever changed a location value), which should temper any wave resting on location churn**; W2a archive measured + bounded, dual-write ON, backfill terminal; **W2 ACTIVATION SHIPPED 2026-09-05 — all seven portal contracts activated and SHADOWED in one wave (W2-6…W2-12), 43 entries inert→executable, mig 470 closing the four-method survivorship-policy gap; the re-mine lane can now mine and nothing it mines serves until the operator un-shadows each portal off the W2-13 gate report** | [roadmap/location-data.md](roadmap/location-data.md) |
