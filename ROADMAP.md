...
_Last refreshed: 2026-05-17 20:01 UTC_

**Branch:** `claude/rubric-confidence-policy`

**Database:** unavailable this session (`SUPABASE_DB_URL` not set or unreachable).

**Migrations on disk:** 74 files, latest `071_skill_refiner_v2_prompt.sql`.
...
3daaca8 roadmap: refresh auto-status block
3884734 refiner: v2 prompt — preserve section structure + translate vague feedback
