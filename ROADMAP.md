...
| Location data | 🟡 active (W0) | Greenfield location SSOT (claims → resolutions → projections on RÚIAN, four-axis precision, licence enforcement); W0 "stop the bleeding" fixes shipping against the current system | [roadmap/location-data.md](roadmap/location-data.md) |
