...
| NEW DEDUP | 🟡 active (W1) | **W0 DONE — Gate 0 closed 2026-09-05**: migration 475 dropped the legacy engine's seven queue/state tables (112 MB), their six admin views and the migration-127 index, retired the publication gate outright, and stamped `property_merge_events.generation='legacy'`; the §7 checklist passed all six items. W1 shared prerequisites in progress — see `docs/design/new-dedup/PROGRAM.md` + `CUTOFF.md` | [roadmap/new-dedup.md](roadmap/new-dedup.md) |
