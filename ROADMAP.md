...
| Location data | 🟡 active (W1 shipped) | Greenfield location SSOT (claims → resolutions → projections on RÚIAN, four-axis precision, licence enforcement); W1 spine live in **shadow** (migs 380–389), nothing reads it until W6; W1v next | [roadmap/location-data.md](roadmap/location-data.md) |
