...
### 2026-05: iDNES Reality crawler (portal 3, pilot)
Third portal onto the shared Phase-4 framework — proof that a new portal is
"a fetcher + a parser + a config row," no pipeline divergence. `IdnesClient`
