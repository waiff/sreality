...
| Sold comps | 🟡 active (W1) | Registered sales as their own account-less fact (`sold_transactions`, migration 542) — reas.cz only, per-obec cells, never a listing row and never mixed with asking prices. **W1 in progress**: store + pure parser + fixtures, and the deletion of the false "delisted = transacted-price proxy" claim | [roadmap/sold-comps.md](roadmap/sold-comps.md) |
