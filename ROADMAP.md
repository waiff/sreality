...
| Dedup + canonical listing | 🟡 active | LLM-cost program; funnel now **Anthropic-free** (gpt-5-mini); Session 4 engine-fed batch deferral shipped 2026-07-14 (flag off by default); Session 5a recency-first ordering shipped 2026-07-14; Session 5b (per-family dismissal design) next; see `docs/design/dedup-vision-and-backlog-overhaul.md` | [roadmap/dedup-track.md](roadmap/dedup-track.md) |
