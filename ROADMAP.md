...
| Location data | 🟡 active (W1v shipped) | Greenfield location SSOT (claims → resolutions → projections on RÚIAN, four-axis precision, licence enforcement); W1 spine live in **shadow** (migs 380–389); W1v is the first live consumer (Location quality page); W2/W2a (HTML re-mine + payload archive) and W3 (history backfill) in progress in parallel | [roadmap/location-data.md](roadmap/location-data.md) |
