...
| Location data | 🟡 active (W1/W1v shipped, W2a closing) | Greenfield location SSOT (claims → resolutions → projections on RÚIAN, four-axis precision, licence enforcement); spine live in **shadow** (migs 380–389, 399–400, 402–408), nothing reads it until W6; W2a archive measured + bounded, dual-write ON, 445k backfill running; W2 infra shipped but **inert** — the per-portal contracts (W2-6…W2-12) are the next real work | [roadmap/location-data.md](roadmap/location-data.md) |
