...
- 2026-09-07 (c) — **Membership is STORED and the operator's alone (migration 484).** Two models
  ...
  operator's own move (`POST /tags/{id}/training-membership`, chunked). The 484 backfill REPLAYS
  the pre-#1321 ranked cutoff so the set they had reviewed survives to the row. Four trays:
