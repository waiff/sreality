...
5. **Photo latency.** Fingerprinting photos at download time removes the 2.5-hour wait. *Recommendation: yes, it is a small change in the image drain and helps every consumer of the fingerprints.* (see PR #1602)
