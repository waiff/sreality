...
def _fetch_listing(
    ...
    sql = (
        ...
        "l.area_m2, l.estate_area, l.usable_area, ll.obec_name, ll.okres_name, "
        "l.building_type, l.condition, l.energy_rating, l.ownership "
        "FROM listings l "
...
def _cache_store(
    ...
    *,
    ...
    sql = (
        ...
        "(sreality_id, listing_id, snapshot_id, units, building, confidence, "
