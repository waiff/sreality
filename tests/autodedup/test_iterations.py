...
def test_every_mode_is_registered() -> None:
    assert set(lane.MODES) == {"census", "probes", "export", "judge", "facts", "score",
                               "labels", "record", "incremental", "rt_seed", "rt_parity",
                               "rt_equivalence", "town"}
    ...
    assert set(lane.ITERATION_META) == {"census", "probes", "export", "judge", "facts",
                                        "score", "labels"}
