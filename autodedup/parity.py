...
# The instrument NAMES its scorer the way every other lane does (E90a): `settings=w8`
...
def _population_source(args: Mapping[str, str]) -> str:
    ...
    measure a seed's effect on the certificates BEFORE seeding anything (E91)."""
...
# the frozen cohort statistic the lane joins against (E90).
