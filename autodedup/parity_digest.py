"""What a listing's facts ARE, as three digests — the permanent parity gate's unit (E84).
...
def refusal(report: Mapping[str, Any], *, generation: str, tolerance: int,
    ...
    return (
        ...
        "engine's (E84). Nothing was written and no cursor moved. Re-run `--mode rt_parity` "
