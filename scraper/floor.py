...
def total_floors_from_portal(value: int | None) -> int | None:
    """A portal's stated building PODLAŽÍ count, or None outside the storey band.

    The structured twin of the text miner's `1 <= n <= _FLOOR_MAX`: a count of 0 is
    mmreality's "not stated", and 113 / 731,463,379 are a typo and an id (bezrealitky)."""
    if value is None or isinstance(value, bool):
        return None
